...
public class MvcConfig implements WebMvcConfigurer {
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		...
		registry.addViewController("/administration/createUser").setViewName("/administration/createUser");
		registry.addViewController("/administration/editUser").setViewName("/administration/editUser");
